...
TerminalUI::TerminalUI()
{
    ...
    homePositions[1] = {2, 7};
    homePositions[2] = {2, 19};
    homePositions[3] = {2, 29};
    homePositions[4] = {2, 41};
    homePositions[5] = {2, 55};
    homePositions[6] = {2, 67};
    homePositions[7] = {3, 23};
    homePositions[8] = {4, 5};
    homePositions[9] = {4, 17};
    homePositions[10] = {4, 33};
    homePositions[11] = {4, 48};
    homePositions[12] = {4, 56};
    homePositions[13] = {6, 20};
    homePositions[14] = {7, 5};
    homePositions[15] = {7, 17};
    homePositions[16] = {7, 27};
    homePositions[17] = {7, 41};
    homePositions[18] = {7, 53};
    homePositions[19] = {9, 6};
    homePositions[20] = {9, 15};
    homePositions[21] = {9, 23};
    homePositions[22] = {9, 45};
    homePositions[23] = {9, 52};
    homePositions[24] = {11, 8};
    homePositions[25] = {11, 16};
    homePositions[26] = {11, 25};
    homePositions[27] = {11, 34};
    homePositions[28] = {11, 41};
    homePositions[29] = {11, 50};
    homePositions[30] = {13, 16};
    homePositions[31] = {13, 25};
    homePositions[32] = {13, 43};
}
